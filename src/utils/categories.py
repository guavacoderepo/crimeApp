categories = {
    "Terrorism": {"bandit", "terrorist", "terrorism", "boko haram", "herdsmen", "explosion", "attack", "separatist", "agitation", "ipob", "farmer", "fulani", "gunmen", "ISWAP", "cattle rustlers", "oil war", "militants", "troops", "pipeline explosion", "ESN", "bomb", "pirates", "sea pirates", "customs", "MASSOB", "Amotekun", "shoot", "gun" "duel"},
    ...
    "Robbery": {"highway robbery", "robbery", "armed", "theft", "burglary", "steal", "thieves"},
    ...
    "Others crimes": {"stab", "trial", "crime", "Bribery", "Corruption", "Conspiracy", "Slander", "malpractice", "killing", "uber", "death", "police"}
}
