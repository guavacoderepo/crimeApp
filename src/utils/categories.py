categories = {
    ...
    "Fraud":{"cybercrime", "atm" "fraud", "internet", "forgery", "scam", "wire fraud", "financial", "impersonation", "laundering", "Money", "efcc", "forgery"},
    ...
    "Drug trafficking": {"smuggling", "drug", "drug trafficking"},
    "Abduction":{"kidnapping", "kidnap", "abduction", "abduct"},
    "Sexual abuse": {"rape","raping", "baby factories"},
